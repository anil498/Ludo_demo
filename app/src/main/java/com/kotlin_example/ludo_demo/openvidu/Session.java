package com.kotlin_example.ludo_demo.openvidu;
...
import com.kotlin_example.ludo_demo.observers.CustomPeerConnectionObserver;
import com.kotlin_example.ludo_demo.observers.CustomSdpObserver;
import com.kotlin_example.ludo_demo.websocket.CustomWebSocket;

public class Session {

    private com.kotlin_example.ludo_demo.openvidu.LocalParticipant localParticipant;
    private Map<String, com.kotlin_example.ludo_demo.openvidu.RemoteParticipant> remoteParticipants = new HashMap<>();
    private String id;
    ...
    public void createRemotePeerConnection(final String connectionId) {
        ...
        PeerConnection peerConnection = peerConnectionFactory.createPeerConnection(config, new CustomPeerConnectionObserver("remotePeerCreation") {
            ...
            public void onSignalingChange(PeerConnection.SignalingState signalingState) {
                if (PeerConnection.SignalingState.STABLE.equals(signalingState)) {
                    // SDP Offer/Answer finished. Add stored remote candidates.
                    final com.kotlin_example.ludo_demo.openvidu.RemoteParticipant remoteParticipant = remoteParticipants.get(connectionId);
    ...
    public void createAnswerForSubscribing(com.kotlin_example.ludo_demo.openvidu.RemoteParticipant remoteParticipant, String streamId, MediaConstraints constraints) {
    ...
    public com.kotlin_example.ludo_demo.openvidu.LocalParticipant getLocalParticipant() {
        return this.localParticipant;
    }

    public void setLocalParticipant(com.kotlin_example.ludo_demo.openvidu.LocalParticipant localParticipant) {
        this.localParticipant = localParticipant;
    }

    public com.kotlin_example.ludo_demo.openvidu.RemoteParticipant getRemoteParticipant(String id) {
    ...
    public void addRemoteParticipant(com.kotlin_example.ludo_demo.openvidu.RemoteParticipant remoteParticipant) {
        this.remoteParticipants.put(remoteParticipant.getConnectionId(), remoteParticipant);
    }

    public com.kotlin_example.ludo_demo.openvidu.RemoteParticipant removeRemoteParticipant(String id) {
    ...
    public void leaveSession() {
        ...
        this.activity.runOnUiThread(() -> {
            for (com.kotlin_example.ludo_demo.openvidu.RemoteParticipant remoteParticipant : remoteParticipants.values()) {
